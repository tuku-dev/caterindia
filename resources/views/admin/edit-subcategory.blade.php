      ...
      <div class="col-md-12">
        <div class="widget box">
          <div class="widget-header">
            <h4><i class="fa fa-cutlery"></i> Edit Subcategory</h4>
          </div>
          <div class="widget-content">
            <div class="col-xs-12 col-sm-6">
              ...
              {{ Form::open(array('url' => 'edit-subcategory', 'role' => 'form', 'class' =>'form-horizontal row-border', 'name' => 'frm_adm_det', 'files' => 'true', 'id' => 'frm_adm_det', 'autocomplete' => 'off')) }}
              {!! Form::hidden('reference_id',$data->sub_caid) !!}
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                 {{ Form::select('category_name', $category, $data->cate_id, ['id' => 'category_name','class'=>'form-control','required']) }}
                </div>
              </div>
               <div class="form-group">
                <label class="col-md-4 control-label">Subcategory Name*:</label>
                <div class="col-md-8">
                 {!! Form::text('subcategory_name',$data->subcategory_name,array('id' => 'subcategory_name','required','class'=>'form-control','placeholder'=>'Subcategory Name')) !!}
                </div>
              </div>
