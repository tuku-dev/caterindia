...
@section('title') {{ $seo_info[0]->meta_title.' || Reservation' }} @stop
  ...
  <div class="container">
    <div class="matter">
      ...
      <ul class="list-inline">
        ...
        <li class="list-inline-item"><a href="javascript:void(0);">Reservation</a></li>
      </ul>
    </div>
  </div>
</div>
      ...
      <div class="col-md-12 col-xs-12"> 
        ...
        <form action="http://www.spheretheme.com/steam/mailer.php" method="post" class="row reservation-form" novalidate="novalidate">
          ...
          <div class="form-group col-md-4 col-sm-6"> <i class="icofont icofont-ui-calendar"></i>
            <input name="date" placeholder="date" id="input-date" class="form-control" type="text" required>
          </div>
