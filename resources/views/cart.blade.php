  ...
  <div class="container">
    <div class="matter">
      ...
      <ul class="list-inline">
        ...
        <li class="list-inline-item"><a href="javascript:void(0);">Shopping Cart</a></li>
      </ul>
    </div>
  </div>
</div>
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="table-responsive-md">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td><a href="#"> <img src="{{ asset('public/images/our-menu/01.jpg') }}" class="img-fluid" alt="thumb" title="thumb" /> </a>
                        <div class="name">
                      ...
                      <td class="text-center"><p class="qtypara"> <span id="minus1" class="minus"><i class="icofont icofont-minus"></i></span>
                      ...
                      <td class="text-center">$23.00</td>
                      <td class="text-center"><button type="button"><i class="icofont icofont-close-line"></i></button></td>
                    </tr>
                    <tr>
                      <td><a href="#"> <img src="{{ asset('public/images/our-menu/01.jpg') }}" class="img-fluid" alt="thumb" title="thumb" /> </a>
                        <div class="name">
                      ...
                      <td class="text-center"><p class="qtypara"> <span id="minus2" class="minus"><i class="icofont icofont-minus"></i></span>
                    ...
                    <tr>
                      <td colspan="5"><h3 class="text-right">SUBTOTAL - $46.50</h3>
                        <div class="buttons float-left"> <a href="shop.html" class="btn btn-theme btn-md btn-wide">Continue Shopping</a> </div>
                        <div class="buttons float-right"> <a href="#tab-info" data-toggle="tab" class="btn btn-theme btn-md btn-wide">Checkout</a> </div></td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div class="tab-pane col-md-12 col-12" id="tab-info">
            <div class="row">
              ...
              <div class="col-md-12 col-12">
                <div class="buttons float-left"> <a href="#tab-cart" data-toggle="tab" class="btn btn-theme btn-md btn-wide">Shopping Cart</a> </div>
                <div class="buttons float-right"> <a href="#tab-payment" data-toggle="tab" class="btn btn-theme btn-md btn-wide">Continue</a> </div>
              </div>
            </div>
          </div>
              ...
              <fieldset>
                <div class="form-group ">
                  <ul class="list-inline text-center link">
                    <li class="list-inline-item active"> <a href="#"><img src="{{ asset('public/images/shop/visacard.png') }}" alt="visa" title="visa" class="img-fluid"></a> </li>
                    <li class="list-inline-item"> <a href="#"><img src="{{ asset('public/images/shop/master.png') }}" alt="master" title="master" class="img-fluid"></a> </li>
                    <li class="list-inline-item"> <a href="#"><img src="{{ asset('public/images/shop/discovers.png') }}" alt="discover" title="discover" class="img-fluid"></a> </li>
                    <li class="list-inline-item"> <a href="#"><img src="{{ asset('public/images/shop/pay.png') }}" alt="paypal" title="paypal" class="img-fluid"></a> </li>
                  </ul>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-12 col-12 text-center">
                    <div class="buttons"> <a href="#tab-cart" data-toggle="tab" class="btn btn-theme btn-md btn-wide">Shopping Cart</a> <a href="thank-you.html" class="btn btn-theme btn-md btn-wide">Place Order</a> </div>
                  </div>
                </div>
              </fieldset>
            </form>
